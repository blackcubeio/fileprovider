<?php  //[STAMP] c6e9d70e5a1d6b39e181abf30bae3ce3
// phpcs:ignoreFile
namespace Blackcube\FileProvider\Tests\Support\_generated;
...
trait FunctionalTesterActions
{
     ...
     *
     *
     * @see \Blackcube\FileProvider\Tests\Support\Helper\Functional::getTestId()
     */
    public function getTestId(): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getTestId', func_get_args()));
    }
     ...
     * @see \Blackcube\FileProvider\Tests\Support\Helper\Functional::getLocalTmpPath()
     */
    public function getLocalTmpPath(): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getLocalTmpPath', func_get_args()));
    }
     ...
     * @see \Blackcube\FileProvider\Tests\Support\Helper\Functional::createTestFile()
     */
    public function createTestFile(string $name, int $size = 1024): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createTestFile', func_get_args()));
    }
     ...
     * @see \Blackcube\FileProvider\Tests\Support\Helper\Functional::createTestFileWithContent()
     */
    public function createTestFileWithContent(string $name, string $content): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createTestFileWithContent', func_get_args()));
    }
     ...
     * @see \Blackcube\FileProvider\Tests\Support\Helper\Functional::createTestImage()
     */
    public function createTestImage(string $name, int $width = 100, int $height = 100): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createTestImage', func_get_args()));
    }
     ...
     * @see \Blackcube\FileProvider\Tests\Support\Helper\Functional::createTestSvg()
     */
    public function createTestSvg(string $name): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createTestSvg', func_get_args()));
    }
     ...
     * @see \Blackcube\FileProvider\Tests\Support\Helper\Functional::splitFileIntoChunks()
     */
    public function splitFileIntoChunks(string $filePath, int $chunkSize): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('splitFileIntoChunks', func_get_args()));
    }
     ...
     *
     * Get file content
     * @see \Blackcube\FileProvider\Tests\Support\Helper\Functional::getFileContent()
     */
    public function getFileContent(string $path): string {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getFileContent', func_get_args()));
    }
}
